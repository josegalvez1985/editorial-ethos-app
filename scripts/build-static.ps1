...
# Doc:  DESPLIEGUE.md
#
# Sirve para probar en local exactamente lo que se va a publicar en
# www.ethospy.online, sin esperar el workflow. La salida queda en dist\client.
...
$faltan = @("index.html", "404.html", ".nojekyll", "CNAME") | Where-Object {
