...
**En producción el sitio se publica en <https://josegalvez1985.github.io/editorial-ethos-app/>
desde GitHub Pages** (`ethospy.online` redirige ahí), que es hosting estático: el proxy **no**
corre y el navegador le pega directo a ORDS. Ver [`DESPLIEGUE.md`](DESPLIEGUE.md).
